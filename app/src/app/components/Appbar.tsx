...
const styles = {
  appBar: `w-full h-14 px-2 bg-[#111314] border-b-[1px] border-[#EEF7FF] border-opacity-5`,
  wrapper: `w-full xl:w-10/12 h-full flex justify-between gap-2 mx-auto`,
  logoContainer: `w-fit h-full flex items-center justify-center gap-2 cursor-pointer`,
  logoIcon: `w-8 h-8`,
  ...
  walletContainer: `w-fit h-fit flex justify-center items-center gap-3 self-center`,
};
